...
from languagemodeling.ngram import compute_ngram, compute_1gram
...
if __name__ == '__main__':
    ...
    filename = 'eng-za_web_2013_100K-sentences.txt_test'
    test_set = LeipzigCorpusReader(filename)
    ...
    print('Perplexity: %f, log probability: %f, cross entropy: %f' %
          (perplexity, log_probability, cross_entropy))
